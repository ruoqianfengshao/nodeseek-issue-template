...
#${APP_ID} .nsit-section{padding:14px 0;border-bottom:1px solid var(--nsit-line)}#${APP_ID} .nsit-section:last-child,#${APP_ID} .nsit-tg-contact{border-bottom:0}#${APP_ID} .nsit-section p{margin:3px 0 10px;font-size:14px}#${APP_ID} .nsit-basic .nsit-grid{grid-template-columns:repeat(10,minmax(0,1fr))}#${APP_ID} .nsit-basic .nsit-field--vendor,#${APP_ID} .nsit-basic .nsit-field--model{grid-column:span 5}#${APP_ID} .nsit-basic .nsit-field--cpu,#${APP_ID} .nsit-basic .nsit-field--memory,#${APP_ID} .nsit-basic .nsit-field--disk,#${APP_ID} .nsit-basic .nsit-field--bandwidth,#${APP_ID} .nsit-basic .nsit-field--traffic{grid-column:span 2}#${APP_ID} .nsit-title-divider{height:1px;margin:16px 0 0;background:var(--nsit-line)}#${APP_ID} .nsit-post-title{margin-top:0}#${APP_ID} .nsit-title-hint{margin-left:6px;color:var(--nsit-muted);font-size:12px;font-weight:400}
    ...
    const modelSuggestionStyles = `
      #${APP_ID} .nsit-traffic-field{position:relative}#${APP_ID} .nsit-traffic-label{display:flex;align-items:center;justify-content:space-between;gap:6px}#${APP_ID} .nsit-traffic-label-actions{display:flex;align-items:center;gap:4px}#${APP_ID} .nsit-traffic-remaining-trigger{margin:0;padding:0;border:0;background:transparent;color:#27834a;font-size:12px;font-weight:650;cursor:pointer;white-space:nowrap}#${APP_ID} .nsit-traffic-remaining-trigger:hover{color:#d9961c}#${APP_ID} .nsit-traffic-remaining-trigger:disabled{color:#8794aa;cursor:not-allowed}#${APP_ID} .nsit-traffic-usage-popover{position:absolute;z-index:50;top:29px;right:0;display:grid;width:250px;gap:9px;border:1px solid #d8e0eb;border-radius:9px;background:#fff;padding:11px;box-shadow:0 10px 24px rgba(31,44,67,.2);color:#506078}#${APP_ID} .nsit-traffic-usage-popover label{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:7px;white-space:nowrap;font-size:13px}#${APP_ID} .nsit-traffic-usage-popover label input{min-width:0;padding:5px 7px}#${APP_ID} .nsit-traffic-usage-popover label em{font-style:normal;white-space:nowrap}#${APP_ID} .nsit-traffic-usage-popover input[type="range"]{height:16px;padding:0;accent-color:#d9961c}#${APP_ID} .nsit-traffic-usage-presets{display:grid;grid-template-columns:repeat(5,1fr);gap:4px}#${APP_ID} .nsit-traffic-usage-presets button{margin:0;padding:3px 0;border-radius:4px;color:#66758d;font-size:11px}#${APP_ID} .nsit-traffic-usage-presets button:hover{border-color:#d9961c;background:#fff8ea;color:#8b5c00}
